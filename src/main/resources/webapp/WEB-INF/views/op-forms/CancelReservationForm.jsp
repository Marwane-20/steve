...
<form:form action="${ctxPath}/manager/operations/${opVersion}/CancelReservation" modelAttribute="params">
    <section><span><fmt:message key="form.chargePointsWithOcpp" /> ${opVersion}</span></section>
    <%@ include file="../00-cp-single.jsp" %>
    <section><span><fmt:message key="form.parameters" /></span></section>
    <table class="userInput">
        <tr>
            <td><fmt:message key="form.existingReservationId" />:</td>
            <td><form:select path="reservationId" disabled="true" /></td>
        </tr>
        <tr>
            <td></td>
            <td>
