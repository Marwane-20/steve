...
<form:form action="${ctxPath}/manager/operations/${opVersion}/ChangeAvailability" modelAttribute="params">
    ...
    <table class="userInput">
        <tr>
            ...
            <td>
                <form:input path="connectorId" placeholder="<fmt:message key='form.connectorIdPlaceholder' />" />
            </td>
        </tr>
        <tr>
            <td><fmt:message key="form.availabilityType" /></td>
            <td>
                <form:select path="availType">
