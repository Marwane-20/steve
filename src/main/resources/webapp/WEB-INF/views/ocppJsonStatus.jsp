...
<div class="content">
    <div>
        <section>
            <span>
                <fmt:message key="connection.status.for.json.charge.points" />
                <a class="tooltip" href="#">
                    <img src="${ctxPath}/static/images/info.png" style="vertical-align:middle">
                    <span>
                        <fmt:message key="tooltip.connection.info" />
                    </span>
                </a>
            </span>
        </section>
        <table class="res">
            <thead>
                <tr>
                    ...
                    <th data-sort="string"><fmt:message key="ocpp.version" /></th>
                    <th data-sort="date"><fmt:message key="connected.since" /></th>
                    <th data-sort="string"><fmt:message key="connection.duration" /></th>
                </tr>
            </thead>
            <tbody>
